...
| last_login_datetime              | TIMESTAMP     | last login to app/web of platform                                             |
| last_login_date                  | DATE          | last login to app/web of platform                                             |
...
| create_datetime                     | DATE          | Datetime of the order when its created (epoch time)                           |        
| complete_datetime                   | DATE          | Datetime of the order when its completed / accepted by the buyer after receiving all the parcels for the order (local time in string)                                                                                          |
| release_datetime                    | DATE          | Datetime when the order should already be completed and escrow started        |
| cancel_datetime                     | DATE          | Datetime of the order when its canceled by the buyer (local time in string)   |
